            ...
            <Radio value="system" className="cursor-pointer outline-hidden">
              {({ checked }) => (
                <>
                  ...
                  <p className="text-xs-plus mt-1.5 text-center">System</p>
                </>
              )}
            </Radio>
            ...
            <Radio value="dark" className="cursor-pointer outline-hidden">
              {({ checked }) => (
                <>
                  ...
                  />
                  <p className="text-xs-plus mt-1.5 text-center">Dark</p>
                </>
              )}
            </Radio>
          </div>
            ...
            >
              {({ checked }) => (
                <>
                  ...
                  <p className="text-xs-plus mt-1.5 text-center">Main Layout</p>
                </>
              )}
            </Radio>
