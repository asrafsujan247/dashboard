                  ...
                  <div className="flex justify-end">
                    <div className="flex items-center gap-1 py-2 font-medium">
                      ...
                      {channel.viewImpression === 1 ? (
                        <ArrowTrendingUpIcon className="size-3 text-this-success" />
                      ) : (
                        <ArrowTrendingDownIcon className="size-3 text-this-error" />
                      )}
                    </div>
                    <div className=" mx-1.5 my-2 w-px bg-gray-200"></div>
                  </div>
                </td>
                <td>
