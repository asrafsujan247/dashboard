...
const CountrySelect = forwardRef<HTMLElement, CountrySelectProps>(({ onChange, value, name, error }, ref) => {
  ...
  return (
    <Combobox
      ...
      onChange={(val: Country | null) => onChange(val?.code)}
      name={name}
      ref={ref}
    >
          ...
          <div className="relative mt-1.5">
            <div className="relative w-full cursor-pointer overflow-hidden">
              <ComboboxInput
                ...
                error={error}
                displayValue={(val: Country | null) => val?.name || ""}
