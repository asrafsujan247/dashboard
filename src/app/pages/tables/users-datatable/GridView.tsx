...
function Item({ row, table }: { row: Row<User>; table: Table<User> }) {
        ...
        {...{
          ...
          indicator: (
            <Transition
              ...
              color="primary"
              className="right-0 bottom-0 flex size-6 items-center justify-center"
            >
...
function Actions({ row, table }: { row: Row<User>; table: Table<User> }) {
